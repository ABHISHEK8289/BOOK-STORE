        ...
        <div className="shadow border rounded p-5 border-gray-400">
          <div className="md:grid grid-cols-4 gap-x-10">
            ...
            <div className="col-span-1">
              <img className='w-full' src="/public/The_Discovery_of_India.jpg" alt="" />
            </div>
            {/* book details column */}
          ...
          <div className="bg-white rounded-2xl md:w-250 w-100">
            ...
            <div className="relative p-5">
              ...
              <div className="md:flex flex-wrap my-4">
                <img className='md:w-75 w-25 md:me-2 mb-3 md:mb-0' src="/public/The_Discovery_of_India.jpg" alt="" />
                <img className='md:w-75 w-25 md:me-2 mb-3 md:mb-0' src="/public/The_Discovery_of_India.jpg" alt="" />
                <img className='md:w-75 w-25 md:me-2 mb-3 md:mb-0' src="/public/The_Discovery_of_India.jpg" alt="" />
              </div>
