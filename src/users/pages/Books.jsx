  ...
  return (
    ...
    <div className="flex justify-center items-center flex-col">
      ...
      <div className="flex my-5">
        <input type="text" placeholder='Search by Title' className="border border-gray-400 w-90" />
      ...
      <div className="md:grid grid-cols-4 md:px-20 p-5 mb-10">
        ...
        <div className="col-span-3">
          <div className="md:grid grid-cols-4 mt-5 md:mt-0">
            ...
            <img height={'300px'} width={'300px'} src="/public/The_Discovery_of_India.jpg" alt="" />
